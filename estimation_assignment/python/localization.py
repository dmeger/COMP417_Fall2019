...
def dynamics_model(state, control, dt):
    # TODO: fill this
    expected_state = State(0., 0.)     # MUST CHANGE THESE VALUES
    return expected_state

def measurement_model(state, landmark):
    # TODO: fill this
    expected_observation = Observation(0., 0.)                # MUST CHANGE THESE VALUES
...
class LocalizationWithRangeMeasurements(object):
    ...
    def cost_function(self, x):
        ...
        F = np.array([1.])                                                      # MUST CHANGE THIS VALUE!
        ...
        deviation_from_init_state = np.array([1.])                               # MUST CHANGE THIS VALUE!
